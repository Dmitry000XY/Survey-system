...
@users_router.get(
    ...
    responses={200: {"description": "List of users returned."}},
)
...
@users_router.put(
    ...
    response_model=UserOut,
    status_code=status.HTTP_200_OK,
    responses={200: {"description": "User successfully updated."}, 404: {"description": "User not found."}},
)
...
@users_router.delete(
    ...
    responses={204: {"description": "User successfully deleted."}, 404: {"description": "User not found."}},
)
async def delete_user(user_id: int, service: user_service):
    await service.delete_user(user_id)
    return Response(
        status_code=status.HTTP_204_NO_CONTENT, content=json.dumps({"message": "User successfully deleted."})
    )
