...
from .custom_types import serialpk, wp_timestamp
...
class WPForm(WPBaseModel):
    ...
    __table_args__ = (Index("form_key", "form_key", unique=True),)
    ...
    fields: Mapped[list["WPField"]] = relationship("WPField", back_populates="form", order_by="WPField.field_order")
